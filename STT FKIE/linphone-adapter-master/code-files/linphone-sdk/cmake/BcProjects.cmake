...
if(BUILD_MEDIASTREAMER2)
	...
	if(ENABLE_LYRA)
		add_subdirectory("mslyra")
		list(APPEND MEDIASTREAMER2_PLUGINS_TARGETS mslyra)
	else()
		linphone_sdk_add_dummy_library("mslyra")
	endif()
	if(ENABLE_SPEECHTEXT)
		add_subdirectory("msspeechtext")
		list(APPEND MEDIASTREAMER2_PLUGINS_TARGETS msspeechtext)
	else()
		linphone_sdk_add_dummy_library("msspeechtext")
	endif()
	if(ENABLE_MELP)
		add_subdirectory("msmelp")
		list(APPEND MEDIASTREAMER2_PLUGINS_TARGETS msmelp)
	else()
		linphone_sdk_add_dummy_library("msmelp")
	endif()
	if(ENABLE_MELPWB)
		add_subdirectory("msmelpwb")
		list(APPEND MEDIASTREAMER2_PLUGINS_TARGETS msmelpwb)
	else()
		linphone_sdk_add_dummy_library("msmelpwb")
	endif()
	if(ENABLE_OBOE)
