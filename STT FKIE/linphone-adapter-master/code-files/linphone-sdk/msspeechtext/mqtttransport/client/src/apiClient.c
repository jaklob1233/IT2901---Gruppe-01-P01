...
mqtttransport_apiClient_t *mqtttransport_apiClient_create() {
    mqtttransport_apiClient_t *apiClient = malloc(sizeof(mqtttransport_apiClient_t));
    apiClient->basePath = strdup("http://localhost:5000/mqtttransport");
...
mqtttransport_sslConfig_t *mqtttransport_sslConfig_create(const char *clientCertFile, const char *clientKeyFile, const char *CACertFile, int insecureSkipTlsVerify) {
    mqtttransport_sslConfig_t *sslConfig = calloc(1, sizeof(mqtttransport_sslConfig_t));
    if ( clientCertFile ) {
...
void mqtttransport_apiClient_invoke(mqtttransport_apiClient_t    *apiClient,
                      const char    *operationParameter,
                      list_t        *queryParameters,
...
size_t writeDataCallback(void *buffer, size_t size, size_t nmemb, void *userp) {
    ...
    mqtttransport_apiClient_t *apiClient = (mqtttransport_apiClient_t *)userp;
