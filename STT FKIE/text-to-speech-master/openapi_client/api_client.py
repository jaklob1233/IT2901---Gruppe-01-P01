...
class TextToSpeechApiClient:
    def __init__(self, base_url: str, default_headers: Optional[Dict[str, str]] = None):
        """Initialize the AudioWebhook API client.
    ...
    def on_new_audio_post(
        self,
        on_new_audio_post_request: Dict[str, Union[int, str]],
        endpoint: str = "/on_new_audio",
        ...
        """Send a POST request to the /on_new_audio endpoint.

        Parameters:
            on_new_audio_post_request: The JSON payload containing audio data and metadata.
        ...
        try:
            ...
            logger.debug("Payload: %s", on_new_audio_post_request)

            response = requests.post(
                url,
                json=on_new_audio_post_request,
                headers=headers,
