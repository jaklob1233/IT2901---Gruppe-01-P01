...
PayloadType payload_type_lyra_3200 = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                    CLOCK_RATE(16000),
                                    BITS_PER_SAMPLE(0),
                                    ZERO_PATTERN(NULL),
                                    PATTERN_LENGTH(0),
...
PayloadType payload_type_lyra_6000 = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                    CLOCK_RATE(16000),
                                    BITS_PER_SAMPLE(0),
                                    ZERO_PATTERN(NULL),
                                    PATTERN_LENGTH(0),
...
PayloadType payload_type_lyra_9200 = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                    CLOCK_RATE(16000),
                                    BITS_PER_SAMPLE(0),
                                    ZERO_PATTERN(NULL),
                                    PATTERN_LENGTH(0),
...
PayloadType payload_type_speechtext = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                        CLOCK_RATE(16000),
                                        BITS_PER_SAMPLE(0),
                                        ZERO_PATTERN(NULL),
                                        PATTERN_LENGTH(0),
                                        NORMAL_BITRATE(500),
                                        MIME_TYPE("SPEECHTEXT"),
                                        CHANNELS(1),
                                        RECV_FMTP(NULL),
                                        SEND_FMTP(NULL),
                                        NO_AVPF,
...
PayloadType payload_type_melp_600 = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                      CLOCK_RATE(8000),
                                      BITS_PER_SAMPLE(0),
                                      ZERO_PATTERN(NULL),
                                      PATTERN_LENGTH(0),
...
PayloadType payload_type_melp_1200 = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                      CLOCK_RATE(8000),
                                      BITS_PER_SAMPLE(0),
                                      ZERO_PATTERN(NULL),
                                      PATTERN_LENGTH(0),
...
PayloadType payload_type_melp_2400 = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                    CLOCK_RATE(8000),
                                    BITS_PER_SAMPLE(0),
                                    ZERO_PATTERN(NULL),
                                    PATTERN_LENGTH(0),
...
PayloadType payload_type_melpwb = {TYPE(PAYLOAD_AUDIO_PACKETIZED),
                                      CLOCK_RATE(16000),
                                      BITS_PER_SAMPLE(0),
                                      ZERO_PATTERN(NULL),
                                      PATTERN_LENGTH(0),
