...
#include "include/mqtttransport/api-server.h"
...
using namespace org::openapitools::mqtttransport::server::api;

int org::openapitools::mqtttransport::server::api::start_server() {
#ifdef __linux__
    std::vector<int> sigs{SIGQUIT, SIGINT, SIGTERM, SIGHUP};
    setUpUnixSignals(sigs);
#endif
    Pistache::Address addr(Pistache::Ipv4::any(), Pistache::Port(5100));
...
int org::openapitools::mqtttransport::server::api::stop_server() {
